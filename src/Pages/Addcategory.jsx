...
export default function Addcategory() {
  ...
  const handleImageChange = (event) => {
    const file = event.target.files[0];    // important to send image to backend server
   ...
   const handleSubmitCategory =()=>{
    alert("YES IT IS READY TO CREATE ")
    console.log("CATEGORY NAME:",name)
    console.log("CATEGORY DESCRIPTION:",description)
    console.log("CATEGORY IMAGE:",selectedImage)


    // use axios and send the data to server backend
  ...
  return (
    <>
      ...
      <div className="category-details-form">
        ...
        <textarea placeholder="Enter category description" onChange={(e)=>setDescription(e.target.value)}></textarea>
